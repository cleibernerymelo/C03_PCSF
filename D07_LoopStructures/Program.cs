    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            string[] turma = { "joao", "jose", "maira", "joaquim", "davi" };
            string[] turma1 = new string[5] { "joao", "jose", "maira", "joaquim", "davi" };
            ...
            foreach (string item in turma)
            {
                //item = turma[0] --> elemento do vetor
                //item = turma[1]
                //item = turma[2]
