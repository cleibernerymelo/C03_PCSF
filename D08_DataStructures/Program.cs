        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            // Dimensionar dinamicamente e atribuir duma só vez
             //string[,] cursos = new string[2,5]
            //{
            //    { "Curso1", "BD", "aa", "bb", "aaaa"},
            //    { "Curso2", "LP", "asdsad", "sadsad", "asdda"},
            //};

            Utility.WriteTitle("Manipulando vetor com FOR e listando com FOREACH");
            string[,] cursos = new string[2, 5];
            int linha, coluna;
            for (linha = 0; linha < 2; linha++)
            {
                ...
                //    Console.Write("Area: ");
                //    cursos[linha, colunaValor] = Console.ReadLine();
                ...
                //}
                Console.Write("\nArea: ");
                cursos[linha, 0] = Console.ReadLine();
                Console.Write("Categoria: ");
                cursos[linha, 1] = Console.ReadLine();
                Console.Write("Curso: ");
                cursos[linha, 2] = Console.ReadLine();
                Console.Write("Campos: ");
                cursos[linha, 3] = Console.ReadLine();
                Console.Write("Polo: ");
                cursos[linha, 4] = Console.ReadLine();
                Utility.WriteTitle("Novo Registo");
